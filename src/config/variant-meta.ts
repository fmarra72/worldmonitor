...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'GEOVIX - Real-Time Global Intelligence Dashboard',
  ...
  tech: {
    title: 'GEOVIX Tech - Real-Time AI & Tech Industry Dashboard',
    ...
    url: 'https://geovix-monitor.vercel.app/dashboard-tech.html',
    siteName: 'GEOVIX Tech',
    shortName: 'GEOVIX Tech',
  ...
  happy: {
    title: 'GEOVIX Good News - Good News & Global Progress',
    ...
    url: 'https://geovix-monitor.vercel.app/dashboard-happy.html',
    siteName: 'GEOVIX Good News',
    shortName: 'GEOVIX Good News',
  ...
  finance: {
    title: 'GEOVIX Finance - Real-Time Markets & Trading Dashboard',
    ...
    url: 'https://geovix-monitor.vercel.app/dashboard-finance.html',
    siteName: 'GEOVIX Finance',
    shortName: 'GEOVIX Finance',
  ...
  commodity: {
    title: 'GEOVIX Commodity - Real-Time Commodity Markets & Supply Chain Dashboard',
    ...
    url: 'https://geovix-monitor.vercel.app/dashboard-commodity.html',
    siteName: 'GEOVIX Commodity',
    shortName: 'GEOVIX Commodity',
  ...
  energy: {
    title: 'GEOVIX Energy - Real-Time Global Energy Intelligence Dashboard',
    ...
    url: 'https://geovix-monitor.vercel.app/dashboard-energy.html',
    siteName: 'GEOVIX Energy',
    shortName: 'GEOVIX Energy',
