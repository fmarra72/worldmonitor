...
export function renderVariantNoscriptMainHtml(variant: VariantSeoKey, meta: VariantMeta): string {
  ...
  return `<main id="dashboard-noscript" class="dashboard-noscript">
        ...
        ${about}
        <p>Visit the <a href="${CANONICAL_ORIGIN}">GEOVIX homepage</a> for the platform overview, or use the indexable reference pages below without enabling JavaScript.</p>
