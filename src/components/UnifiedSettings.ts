    ...
    setTrustedHtml(this.overlay, trustedHtml(`
      <div class="modal unified-settings-modal">
        ...
        <div class="unified-settings-tabs" role="tablist" aria-label="Settings">
          ...
          ${showEmbedsTab ? `<button class="${tabClass('embeds')}" tabindex="${this.activeTab === 'embeds' ? 0 : -1}" data-tab="embeds" role="tab" aria-selected="${this.activeTab === 'embeds'}" id="us-tab-embeds" aria-controls="us-tab-panel-embeds">Embeds</button>` : ''}
